    ...
    return (
      <div style={rootStyle}>
        ...
        <div style={{maxWidth:600,margin:"0 auto",padding:"16px 12px 40px"}} ref={scrollRef}>
          ...
          {/* Domain completed banner — auto-advance prompt */}
          {domainJustCompleted && (
            <div style={{background:"linear-gradient(135deg,#f0fdf4,#dcfce7)",border:"2px solid #86efac",borderRadius:14,padding:"16px 18px",marginBottom:16,textAlign:"center"}}>
              ...
              <div style={{fontSize:12,color:"#16a34a",marginBottom:14}}>
                Please scroll down to continue to the next section
              </div>
              <button onClick={()=>{setDomain(d=>d+1);scrollRef.current?.scrollTo(0,0);}}
                style={{background:"linear-gradient(135deg,#16a34a,#15803d)",color:"white",border:"none",borderRadius:10,padding:"12px 28px",fontSize:14,fontWeight:700,cursor:"pointer",boxShadow:"0 4px 12px rgba(22,163,74,0.3)"}}>
                Next: {DOMAIN_META[domain].icon} {DOMAIN_META[domain].name} →
              </button>
            </div>
          )}
          ...
          {allDone && (
            <div style={{marginTop:24,background:"white",borderRadius:16,padding:"20px",border:"2px solid #6d28d9",boxShadow:"0 4px 20px rgba(109,40,217,0.15)"}}>
              <div style={{textAlign:"center",marginBottom:16}}>
                <div style={{fontSize:32,marginBottom:8}}>🎉</div>
                <div style={{fontSize:16,fontWeight:800,color:"#3b1f6e",marginBottom:4}}>All sections complete!</div>
                <div style={{fontSize:12,color:"#64748b",lineHeight:1.6}}>
                  Please review your responses before submitting.<br/>
                  Once submitted, your results will be calculated and your report will be ready.
                </div>
              </div>
              ...
              <p style={{textAlign:"center",fontSize:10,color:"#9ca3af",marginTop:10}}>
                Your responses are saved securely. Report generates instantly after submission.
              </p>
            </div>
          )}
        </div>
